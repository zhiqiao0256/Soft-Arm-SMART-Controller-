    ...
    def smcNDOBwithInputBoundAndSat(self):
        ...
        if self.flag_contact_mode==0: # normal smcndo
            ...
            if self.flag_stage==0: # normal mode
                ...
                # if np.absolute(self.x1_error_current) >= self.x1_error_max_value: # swith to compliant mode
                if np.absolute(self.smcNDOB_dist_est_inner_tqr)>= self.smcNDOB_th*0.5: #stay in compliant
                    dxd1=0.
                    ddxd1=0.
                    xd1=self.xd1_new
                    self.flag_stage =1
                ...
                elif np.absolute(self.smcNDOB_dist_est_inner_tqr)< self.smcNDOB_th*0.5: # switch to recovery mode
