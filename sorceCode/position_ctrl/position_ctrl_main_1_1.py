...
def main():
    try:
        ...
        if flag_ctrl_mode==0:
            ...
            p_client=smart3_main.pc_client()
        p_client.positionProfile_flag=3 
        p_client.flag_use_mocap=1
        p_client.trailDuriation=60.
        p_client.smcNDOB_lambda= 10.0
        p_client.smcNDOB_k_sig = 10.0# ori 30
        p_client.smcNDOB_eta = 40.0
        p_client.smcNDOB_kp_sig = 30.0# ori 10 ksf in paper
        p_client.smcNDOB_kw=10.0
        p_client.smcNDOB_th=0.2# N.m
        p_client.mode_C_to_R_th=0.15
        p_client.mode_R_to_C_th=0.15
