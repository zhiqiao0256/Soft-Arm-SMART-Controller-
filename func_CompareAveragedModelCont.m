function [par_set]=func_CompareAveragedModelCont(par_set)
...
averaged_model=idgrey('func_pressrueController',{par_set.mean_a,par_set.mean_b},fcn_type);
s=tf('z',0.05);
G=par_set.mean_b/(s-par_set.mean_a);
bode(d2c(G))
%%
