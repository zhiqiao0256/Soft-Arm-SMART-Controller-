...
%% data4
close all
%%%% Identify start and end pts for two dataset
fp=figure('Name','ramp','Position',[100,100,600,800]);
testData=par_set.trial4;
testData = func_getPhiThetaBfromXYZ(testData,par_set);
testData_start_pt=358;
testData_end_pt=2357;
testData2=par_set.trial5;
testData2 = func_getPhiThetaBfromXYZ(testData2,par_set);
testData2_start_pt=380;
testData2_end_pt=2378;
subplot(5,1,1)
plot(testData.xd_exp(:,2),'r')
hold on
plot(testData2.xd_exp(:,2),'b')
%%%% compare results
fp=figure('Name','ramp','Position',[100,100,600,400]);
plot(testData.xd_exp(testData_start_pt:testData_end_pt,1)-testData.xd_exp(testData_start_pt,1),testData.xd_exp(testData_start_pt:testData_end_pt,2),'r')
hold on
plot(testData2.xd_exp(testData2_start_pt:testData2_end_pt,1)-testData2.xd_exp(testData2_start_pt,1),testData2.xd_exp(testData2_start_pt:testData2_end_pt,2),'b')
hold on
plot(testData.xd_exp(testData_start_pt:testData_end_pt,1)-testData.xd_exp(testData_start_pt,1),testData.xd_exp(testData_start_pt:testData_end_pt,2),'k')
hold on
ylabel('\theta (rad)')
xlim([0,65])
ylim([-1.1,0])
