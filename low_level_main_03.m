...
%% Estimate controller parameters d_pm=a * pm + b * pd dicrete domain
par_set=func_EstiamtePressCntrlParams_noplot(par_set);
%% Compare averaged model with different trails disc
par_set=func_CompareAveragedModel(par_set);
% %% Estimate controller parameters d_pm=a * pm + b * pd conti. domain
% par_set=func_EstiamtePressCntrlParamsCont(par_set);
% %% Compare averaged model with different trails conti.
% par_set=func_CompareAveragedModelCont(par_set);
